...
public class CrossOver extends MainLabel {
	...
	public CrossOver(Terminal init, int id) {
		myName = "CrossOver Connection";
		icon = new ImageIcon(getClass().getClassLoader().getResource("CrossOver.png"));
		setIcon(icon);
		output = init;
		this.id = id;
	}
